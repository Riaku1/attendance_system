<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'insights' table. 
	...
	*/
	...
	function insights_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function insights_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function insights_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['empID'], $data['month'], $data['year'], $data['earliest_arrival'], $data['latest_arrival'], $data['total_late_days'], $data['total_early_outs'], $data['total_hours_worked'], $data['best_performance']
	...
	*/
	...
	function insights_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function insights_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['empID'], $data['month'], $data['year'], $data['earliest_arrival'], $data['latest_arrival'], $data['total_late_days'], $data['total_early_outs'], $data['total_hours_worked'], $data['best_performance']
	...
	*/
	...
	function insights_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function insights_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function insights_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function insights_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function insights_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function insights_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function insights_batch_actions(&$args) {
