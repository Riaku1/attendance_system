<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'emp_id' table. 
	...
	*/
	...
	function emp_id_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function emp_id_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function emp_id_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function emp_id_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function emp_id_batch_actions(&$args) {
